...
public class AnvilRecipes extends SerializableRecipe {
	...
	public static void registerSmithing() {
		...
		smithingRecipes.add(new AnvilSmithingRecipe(1, new ItemStack(ModItems.gun_ar15, 1), new ComparableStack(ModItems.gun_mp40), new ComparableStack(ModItems.pipe_lead)));
		...
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_44_chlorophyte), new ComparableStack(ModItems.ammo_44), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_5mm_chlorophyte), new ComparableStack(ModItems.ammo_5mm), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_9mm_chlorophyte), new ComparableStack(ModItems.ammo_9mm), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_22lr_chlorophyte), new ComparableStack(ModItems.ammo_22lr), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_50bmg_chlorophyte), new ComparableStack(ModItems.ammo_50bmg), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_50ae_chlorophyte), new ComparableStack(ModItems.ammo_50ae), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_556_chlorophyte), new ComparableStack(ModItems.ammo_556), new ComparableStack(ModItems.pellet_chlorophyte)));
		smithingRecipes.add(new AnvilSmithingRecipe(3, new ItemStack(ModItems.ammo_556_flechette_chlorophyte), new ComparableStack(ModItems.ammo_556_flechette), new ComparableStack(ModItems.pellet_chlorophyte)));
	...
	public static void registerConstructionRecycling() {
		...
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_titanium, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_titanium, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_red_copper, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_red_copper, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_tungsten, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_tungsten, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_aluminium, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_aluminium, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_steel, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_steel, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_rusty_steel, 2), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_steel, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_lead, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_lead, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_beryllium, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_beryllium, 1))}).setTier(1));
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModBlocks.deco_asbestos, 1), new AnvilOutput[] {new AnvilOutput(new ItemStack(ModItems.ingot_asbestos, 1))}).setTier(1));
