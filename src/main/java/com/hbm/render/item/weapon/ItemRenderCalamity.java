...
public class ItemRenderCalamity extends TEISRBase {
	...
	protected ResourceLocation dualStock_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelcaldualstock.png");
	protected ResourceLocation barrel_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelcalbarrel.png");
	protected ResourceLocation stock_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelcalstock.png");
