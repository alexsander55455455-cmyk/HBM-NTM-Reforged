...
public class ItemRenderBullshit extends TEISRBase {
	...
	protected static ResourceLocation mp40_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelmp40.png");
	protected static ResourceLocation spark_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelspark.png");
	protected static ResourceLocation pip_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelpip.png");
	protected static ResourceLocation bomb_rl = new ResourceLocation(Tags.MODID +":textures/models/projectiles/baleflare.png");
