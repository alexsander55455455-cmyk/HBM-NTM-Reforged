...
public class ItemRenderOverkill extends TEISRBase {
	...
	*/protected ModelSpark sparkPlug;
	public static ResourceLocation sparkLoc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelspark.png");
	...
	protected ResourceLocation pipLoc = new ResourceLocation(Tags.MODID + ":textures/models/weapons/modelpip.png");
	protected ResourceLocation noPipLoc = new ResourceLocation(Tags.MODID + ":textures/models/weapons/modelpipnoscope.png");
	protected ResourceLocation blackjackLoc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelpipgrey.png");
	protected ResourceLocation redLoc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelpipred.png");
	protected ResourceLocation silverLoc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelpipsilver.png");
