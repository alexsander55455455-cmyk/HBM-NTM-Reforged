...
public class ItemRenderGunAnim2 extends TEISRBase {
	...
	protected ResourceLocation leverActionLoc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelleveraction.png");
	protected ResourceLocation leverActionDark_rl = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelleveractiondark.png");
	protected ResourceLocation leverBoltAction_green = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelboltactiongreen.png");
	protected ResourceLocation leverBoltAction = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelboltactiondark.png");
