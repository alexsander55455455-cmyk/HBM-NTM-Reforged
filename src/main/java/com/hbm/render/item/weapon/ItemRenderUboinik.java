...
public class ItemRenderUboinik extends TEISRBase {
	...
	private final ModelUboinik uboinik = new ModelUboinik();
	private static final ResourceLocation UBOINIK_TEXTURE = new ResourceLocation(Tags.MODID, "textures/models/weapons/modeluboinik.png");

	@Override
	public void renderByItem(ItemStack itemStackIn) {
		Minecraft.getMinecraft().renderEngine.bindTexture(UBOINIK_TEXTURE);
