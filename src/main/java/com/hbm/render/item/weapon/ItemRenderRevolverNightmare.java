...
public class ItemRenderRevolverNightmare extends TEISRBase {
	...
	protected ResourceLocation n1Loc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelnightmare.png");
	protected ResourceLocation n2Loc = new ResourceLocation(Tags.MODID +":textures/models/weapons/modelnightmare2.png");
