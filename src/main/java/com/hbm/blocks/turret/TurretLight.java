  ...
  public boolean executeHoldAction(World world, int i, double yaw, double pitch, BlockPos pos) {
    ...
    if (te.spin > 25 && i != 0 && i % 2 == 0) {
      ...
      if (!world.isRemote) {
        ...
        bullet.posX = pos.getX() + vector.x * 1.4 + 0.5;
        bullet.posY = pos.getY() + vector.y * 1.4 + 0.87;
        bullet.posZ = pos.getZ() + vector.z * 1.4 + 0.5;
