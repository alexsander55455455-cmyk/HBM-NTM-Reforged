...
public class BlockCrate extends BlockFalling {
    ...
    public static void setDrops() {
        ...
        BlockCrate.addToListWithWeight(weaponList, ModItems.gun_panzerschreck_sedna, 1);
        ...
        BlockCrate.addToListWithWeight(metalList, Item.getItemFromBlock(ModBlocks.machine_blast_furnace), 9);
