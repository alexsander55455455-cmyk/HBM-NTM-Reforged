...
public class WeaponRecipes {
    ...
    public static void register() {
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_flamer_sedna, 1), "WPP", "SCT", "WMI", 'W', new ItemStack(ModItems.wire, 1, Mats.MAT_GOLD.id), 'P', ModItems.pipes_steel, 'S', ModItems.hull_small_steel, 'C', ModItems.coil_tungsten, 'T', ModItems.tank_steel, 'M', ModItems.mechanism_launcher_1, 'I', STEEL.ingot());
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_flamer_topaz, 1), " M ", "MFM", " M ", 'M', WEAPONSTEEL.mechanism(), 'F', ModItems.gun_flamer_sedna );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_uzi_sedna, 1), "BRS", " GM", 'B', DESH.lightBarrel(), 'R', DESH.lightReceiver(), 'S', ANY_PLASTIC.stock(), 'G', ANY_PLASTIC.grip(), 'M', GUNMETAL.mechanism() );
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_uzi_akimbo, 1), "UMU", 'U', ModItems.gun_uzi_sedna, 'M', WEAPONSTEEL.mechanism() );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_panzerschreck_sedna, 1), "BBB", "PGM", 'B', DESH.heavyBarrel(), 'P', STEEL.plateCast(), 'G', DESH.grip(), 'M', GUNMETAL.mechanism() );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_quadro_sedna, 1), "BCB", "BMB", "GG ", 'B', FERRO.heavyBarrel(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ADVANCED), 'M', WEAPONSTEEL.mechanism(), 'G', ANY_PLASTIC.grip() );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_minigun_sedna, 1), "BMG", "BRE", "BGM", 'B', ANY_RESISTANTALLOY.lightBarrel(), 'M', WEAPONSTEEL.mechanism(), 'G', ANY_PLASTIC.grip(), 'R', ANY_RESISTANTALLOY.heavyReceiver(), 'E', ModItems.motor_desh );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_tesla_cannon, 1), "CCC", "BRB", "MGE", 'C', ModItems.coil_copper, 'B', ANY_RESISTANTALLOY.heavyBarrel(), 'R', ANY_RESISTANTALLOY.heavyReceiver(), 'M', WEAPONSTEEL.mechanism(), 'G', ANY_PLASTIC.grip(), 'E', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ADVANCED) );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_fatman, 1), "SSI", "IIM", "WPH", 'S', STEEL.plate(), 'I', STEEL.ingot(), 'W', new ItemStack(ModItems.wire, 1, Mats.MAT_ALUMINIUM.id), 'H', ModItems.hull_small_steel, 'P', Blocks.PISTON, 'M', ModItems.mechanism_launcher_2);
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_tau, 1), " RD", "CTT", "GMS", 'D', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BISMOID), 'C', CU.pipe(), 'T', ModItems.coil_copper_torus, 'G', ANY_HARDPLASTIC.grip(), 'R', BIGMT.lightReceiver(), 'M', BIGMT.mechanism(), 'S', ANY_HARDPLASTIC.stock() );
        ...
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.FLAME_DIESEL, 1), " P ", "BDB", " P ", 'P', STEEL.plate(), 'B', new ItemStack(ModItems.bolt, 1, Mats.MAT_STEEL.id), 'D', ItemCanister.getStackFromFluid(Fluids.DIESEL));
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.FLAME_NAPALM, 1), " P ", "BDB", " P ", 'P', STEEL.plate(), 'B', new ItemStack(ModItems.bolt, 1, Mats.MAT_STEEL.id), 'D', ModItems.canister_napalm);
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.FLAME_GAS, 1), "PDP", "BDB", "PDP", 'P', STEEL.plate(), 'B', new ItemStack(ModItems.bolt, 1, Mats.MAT_STEEL.id), 'D', ModItems.pellet_gas);
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.FLAME_BALEFIRE, 1), " P ", "BDB", " P ", 'P', STEEL.plate(), 'B', new ItemStack(ModItems.bolt, 1, Mats.MAT_STEEL.id), 'D', ItemCanister.getStackFromFluid(Fluids.BALEFIRE));
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.CAPACITOR, 4), "P", "S", "P", 'P', ANY_PLASTIC.ingot(), 'S', SI.billet());
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.CAPACITOR_OVERCHARGE, 4), "P", "O", "P", 'P', ANY_PLASTIC.ingot(), 'O', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CAPACITOR));
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.CAPACITOR_IR, 4), "P", "N", "P", 'P', ANY_PLASTIC.ingot(), 'N', NB.ingot());
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.CT_HOOK, 16), " S ", " P ", " G ", 'S', STEEL.ingot(), 'P', STEEL.pipe(), 'G', ANY_SMOKELESS.dust());
        CraftingManager.addRecipeAuto(DictFrame.fromOne(ModItems.ammo_standard, GunFactory.EnumAmmo.CT_MORTAR, 4), " H ", " P ", " G ", 'H', ANY_HIGHEXPLOSIVE.ingot(), 'P', STEEL.pipe(), 'G', ANY_SMOKELESS.dust());
        ...
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.missile_micro, 1), ModItems.missile_assembly, ModItems.ducttape, new ItemStack(ModItems.ammo_nuke_high) );
        ...
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.missile_schrabidium, 1), ModItems.missile_assembly, ModItems.ducttape, ModItems.grenade_aschrab);
        ...
        //Guns
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_b92), "DDD", "SSC", "  R", 'D', ModItems.plate_dineutronium, 'S', STAR.ingot(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BISMOID), 'R', ModItems.gun_revolver_schrabidium );
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_generic, 4), "RS ", "ITI", " I ", 'I', IRON.plate(), 'R', new ItemStack(ModItems.wire, 1, Mats.MAT_MINGRADE.id), 'S', STEEL.plate(), 'T', Item.getItemFromBlock(Blocks.TNT));
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_frag, 2), " G ", "WGW", " K ", 'G', ModItems.grenade_generic, 'W', Item.getItemFromBlock(Blocks.PLANKS), 'K', Item.getItemFromBlock(Blocks.GRAVEL));
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_aschrab, 1), "RS ", "ITI", " S ", 'I', KEY_CLEARPANE, 'R', new ItemStack(ModItems.wire, 1, Mats.MAT_MINGRADE.id), 'S', STEEL.plate(), 'T', ItemCell.getFullCell(Fluids.ASCHRAB));
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_mk2, 2), " G ", "SGS", " S ", 'G', ModItems.grenade_strong, 'S', Items.GUNPOWDER);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), ItemCanister.getStackFromFluid(Fluids.DIESEL), Items.FLINT);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), ItemCanister.getStackFromFluid(Fluids.BIOFUEL), Items.FLINT);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), ItemCanister.getStackFromFluid(Fluids.PETROIL), Items.FLINT);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), ItemCanister.getStackFromFluid(Fluids.KEROSENE), Items.FLINT);
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_if_sticky, 1), "G", "A", 'G', ModItems.grenade_if_generic, 'A', Items.SLIME_BALL);
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_if_impact, 1), "G", "A", 'G', ModItems.grenade_if_generic, 'A', Items.REDSTONE);
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_if_brimstone, 1), "R", "G", "A", 'G', ModItems.grenade_if_generic, 'R', REDSTONE.dust(), 'A', ModItems.powder_power);
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_if_mystery, 1), " A ", "BGB", " A ", 'G', ModItems.grenade_if_generic, 'A', ModItems.powder_magic, 'B', ModItems.powder_cloud);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_if_hopwire, 1), ModItems.grenade_if_generic, ModItems.singularity_counter_resonant);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_if_spark, 1), ModItems.grenade_if_generic, ModItems.singularity_spark);
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_if_null, 1), ModItems.grenade_if_generic, ModItems.undefined);
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_nuke), "CGC", "CGC", "PAP", 'C', ModBlocks.det_charge, 'G', ModItems.grenade_mk2, 'P', ALLOY.plate(), 'A', Blocks.ANVIL);
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_cloud), "SPS", "CAC", "SPS", 'S', S.dust(), 'P', ModItems.powder_poison, 'C', CU.dust(), 'A', new ItemStack(ModItems.fluid_tank_full, 1, Fluids.SULFURIC_ACID.getID()));
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModBlocks.vent_cloud), "IGI", "ICI", "IDI", 'I', IRON.plate(), 'G', Blocks.IRON_BARS, 'C', ModItems.grenade_cloud, 'D', Blocks.DISPENSER);
        CraftingManager.addRecipeAuto(new ItemStack(ModBlocks.vent_pink_cloud), "IGI", "ICI", "IDI", 'I', IRON.plate(), 'G', Blocks.IRON_BARS, 'C', ModItems.grenade_pink_cloud, 'D', Blocks.DISPENSER);
        ...
        CraftingManager.addRecipeAuto(new ItemStack(ModBlocks.mine_fat, 1), "CDN", 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ANALOG), 'D', ModItems.ducttape, 'N', new ItemStack(ModItems.ammo_nuke) );
        ...
        // Extended Edition Shaped Recipes
        CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_revolver_schrabidium, 1), "SSM", " RW", 'S', SA326.block(), 'W', W.ingot(), 'R', new ItemStack(ModItems.wire, 1, Mats.MAT_SCHRABIDIUM.id), 'M', ModItems.mechanism_special);
        ...
        // Extended Edition Shapeless Recipes
        ...
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_revolver_nightmare2_ammo, 6), new ItemStack(ModItems.clip_revolver_nightmare2));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_44_pip, 6), new ItemStack(ModItems.clip_revolver_pip));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_44, 12), new ItemStack(ModItems.clip_revolver_nopip));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_rocket, 6), new ItemStack(ModItems.clip_rpg));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_stinger_ammo, 6), new ItemStack(ModItems.clip_stinger));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_nuke, 6), new ItemStack(ModItems.clip_fatman));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_mirv, 3), new ItemStack(ModItems.clip_mirv));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_bf_ammo, 2), new ItemStack(ModItems.clip_bf));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_9mm, 32), new ItemStack(ModItems.clip_mp40));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_22lr, 32), new ItemStack(ModItems.clip_uzi));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_12gauge, 24), new ItemStack(ModItems.clip_uboinik));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_20gauge, 24), new ItemStack(ModItems.clip_lever_action));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_20gauge_slug, 24), new ItemStack(ModItems.clip_bolt_action));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_osipr_ammo, 30), new ItemStack(ModItems.clip_osipr));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_immolator_ammo, 64), new ItemStack(ModItems.clip_immolator));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_cryolator_ammo, 64), new ItemStack(ModItems.clip_cryolator));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_566_gold, 40), new ItemStack(ModItems.clip_mp));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_xvl1456_ammo, 64), new ItemStack(ModItems.clip_xvl1456));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_emp_ammo, 6), new ItemStack(ModItems.clip_emp));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_jack_ammo, 12), new ItemStack(ModItems.clip_jack));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_spark_ammo, 4), new ItemStack(ModItems.clip_spark));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_hp_ammo, 12), new ItemStack(ModItems.clip_hp));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_euthanasia_ammo, 16), new ItemStack(ModItems.clip_euthanasia));
        CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_defabricator_ammo, 16), new ItemStack(ModItems.clip_defabricator));

        EEAmmoWorkbenchRecipes.register();
    }
}
