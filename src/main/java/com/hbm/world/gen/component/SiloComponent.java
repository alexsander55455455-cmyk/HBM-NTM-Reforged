...
public class SiloComponent extends Component {
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
        ...
        setBlockState(world, ModBlocks.concrete_colored_ext.getStateFromMeta(5), 16, 25, 11, box); //it's figuring out meta that makes you shoot yourself anyway
        setBlockState(world, ModBlocks.concrete_colored_ext.getStateFromMeta(5), 22, 25, 11, box);
        setBlockState(world, ModBlocks.concrete_colored_ext.getStateFromMeta(5), 22, 25, 17, box);
        ...
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 28, 27, 2, box);
        ...
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 14, 27, 2, box);
        ...
        setBlockState(world, ModBlocks.barbed_wire.getStateFromMeta(5), 14, 28, 2, box);
        //W-facing
        ...
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 13, 26, 11, box);
        ...
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 42, 26, 7, box);
        fillWithBlocks(world, box, 42, 26, 9, 42, 26, 12, ModBlocks.fence_metal);
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 42, 26, 14, box);
        ...
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 27, 26, 20, box);
        fillWithBlocks(world, box, 29, 26, 20, 32, 27, 20, ModBlocks.fence_metal);
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 33, 26, 20, box);
        fillWithBlocks(world, box, 35, 26, 20, 37, 26, 20, ModBlocks.fence_metal);
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 36, 27, 20, box);
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 39, 26, 20, box);
        ...
        //Defense Platforms
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 27, 26, 13, box);
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 32, 26, 13, box);
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 27, 26, 18, box);
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 32, 26, 18, box);
        ...
        //Methusalem
        placeCore(world, box, ModBlocks.turret_howard_damaged, EnumFacing.SOUTH, 29, 27, 15);
        fillSpace(world, box, 29, 27, 15, new int[] { 0, 0, 1, 0, 1, 0 }, ModBlocks.turret_howard_damaged, EnumFacing.SOUTH);
        //Destroyed platform
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 34, 26, 13, box);
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 39, 26, 13, box);
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 34, 26, 18, box);
        setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 39, 26, 18, box);
        ...
        setBlockState(world, ModBlocks.concrete_slab.getStateFromMeta(1), 34, 27, 17, box);
        ...
        setBlockState(world, ModBlocks.concrete_slab.getStateFromMeta(1), 39, 27, 14, box);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 37, 25, 15, box); //deco
        setBlockState(world, ModBlocks.deco_pipe_rim_rusted.getStateFromMeta(0), 37, 26, 15, box);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 36, 25, 16, box);
        setBlockState(world, ModBlocks.deco_pipe_quad_rusted.getStateFromMeta(0), 36, 26, 16, box);
        ...
        //Deco
        setBlockState(world, Blocks.IRON_BARS.getStateFromMeta(0), 35, 27, 7, box);
        setBlockState(world, Blocks.IRON_BARS.getStateFromMeta(0), 39, 27, 7, box);
        placeDoor(world, box, ModBlocks.door_metal, 1, false, rand.nextBoolean(), 37, 26, 5);

        //Stuff not-bolted down
        //Tent
        for(int j = 4; j <= 8; j += 2) {
            setBlockState(world, ModBlocks.steel_beam.getStateFromMeta(2), 20, 26, j, box);
            fillWithMetadataBlocks(world, box, 16, 26, j, 16, 27, j, ModBlocks.steel_beam, 3);
        }
        // TODO this too
        fillWithBlocks(world, box, 16, 28, 4, 17, 28, 8, ModBlocks.brick_concrete_slab);
        fillWithMetadataBlocks(world, box, 18, 27, 4, 19, 27, 8, ModBlocks.brick_concrete_slab, 8);
        fillWithBlocks(world, box, 20, 27, 4, 20, 27, 8, ModBlocks.brick_concrete_slab);
        fillWithMetadataBlocks(world, box, 16, 28, 6, 17, 28, 6, ModBlocks.brick_concrete_slab, 5);
        fillWithMetadataBlocks(world, box, 18, 27, 6, 19, 27, 6, ModBlocks.brick_concrete_slab, 13);
        setBlockState(world, ModBlocks.brick_concrete_slab.getStateFromMeta(5), 20, 27, 6, box);
        //Supplies
        ...
        setBlockState(world, ModBlocks.barrel_corroded.getStateFromMeta(0), 32, 26, 5, box);
        fillWithRandomizedBlocks(world, box, 32, 26, 7, 32, 26, 7, rand, DestroyedBricks);
        setBlockState(world, ModBlocks.barrel_corroded.getStateFromMeta(0), 31, 26, 9, box);
        ...
        setBlockState(world, Blocks.AIR.getDefaultState(), 37, 25, 10, box);
        ...
        for(int i = 0; i < 5; i++) {
            ...
            setBlockState(world, ModBlocks.concrete_smooth_stairs.getStateFromMeta(stairS), 37, 25 - i, 9 + i, box);
        }
        ...
        /* Blue Control Room */
        //Air
        setBlockState(world, Blocks.AIR.getStateFromMeta(0), 36, 23, 17, box);
        ...
        for(int i = 20; i <= 24; i += 4) {
            ...
            setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 26, i, 8, box);
            fillWithBlocks(world, box, 27, i, 2, 28, i, 6, ModBlocks.concrete_smooth);
            setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 29, i, 3, box);
        ...
        setBlockState(world, ModBlocks.concrete_colored.getStateFromMeta(11), 29, 22, 3, box);
        setBlockState(world, ModBlocks.concrete_colored.getStateFromMeta(11), 30, 22, 4, box);
        ...
        setBlockState(world, ModBlocks.concrete_colored.getStateFromMeta(11), 22, 22, 6, box);
        setBlockState(world, ModBlocks.reinforced_glass.getStateFromMeta(0), 23, 22, 6, box);
        setBlockState(world, ModBlocks.reinforced_glass.getStateFromMeta(0), 24, 22, 7, box);
        setBlockState(world, ModBlocks.reinforced_glass.getStateFromMeta(0), 25, 22, 8, box);
        setBlockState(world, ModBlocks.reinforced_glass.getStateFromMeta(0), 26, 22, 9, box);
        setBlockState(world, ModBlocks.reinforced_glass.getStateFromMeta(0), 27, 22, 10, box);
        setBlockState(world, ModBlocks.concrete_colored.getStateFromMeta(11), 27, 22, 11, box);
        ...
        setBlockState(world, ModBlocks.tape_recorder.getStateFromMeta(decoW), 33, 21, 18, box);
        setBlockState(world, ModBlocks.deco_crt.getStateFromMeta(getCRTMeta(1) | 8), 33, 22, 18, box);
        setBlockState(world, ModBlocks.tape_recorder.getStateFromMeta(decoW), 33, 23, 18, box);
        fillWithMetadataBlocks(world, box, 33, 21, 16, 33, 23, 16, ModBlocks.tape_recorder, decoW);
        setBlockState(world, ModBlocks.reinforced_stone_stairs.getStateFromMeta(stairE | 4), 34, 21, 19, box);
        // TODO replace that with enumfied slabs
        setBlockState(world, ModBlocks.brick_concrete_slab.getStateFromMeta(8), 34, 21, 18, box);
        ...
        setBlockState(world, ModBlocks.deco_pipe_framed_green_rusted.getStateFromMeta(pillarNS), 32, 23, 10, box);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 32, 23, 11, box);
        fillWithMetadataBlocks(world, box, 32, 23, 12, 32, 23, 15, ModBlocks.deco_pipe_framed_green_rusted, pillarNS);

        setBlockState(world, ModBlocks.turret_sentry_damaged.getStateFromMeta(0), 30, 21, 16, box);
        //Desk Area
        fillWithBlocks(world, box, 27, 21, 9, 28, 21, 9, ModBlocks.deco_steel);
        setBlockState(world, ModBlocks.deco_beryllium.getStateFromMeta(0), 26, 21, 8, box);
        ...
        setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(decoModelN), 28, 22, 9, box);
        setBlockState(world, Blocks.LEVER.getStateFromMeta(6), 26, 22, 8, box); //placed on ground
        setBlockState(world, Blocks.LEVER.getStateFromMeta(6), 25, 22, 7, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.SOUTH), 28, 21, 7, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST), 27, 21, 5, box);

        setBlockState(world, ModBlocks.tape_recorder.getStateFromMeta(decoE), 30, 21, 5, box);
        setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 27, 21, 3, box);

        setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 25, 22, 2, box);

        placeCore(world, box, ModBlocks.radio_telex, EnumFacing.WEST, 25, 21, 5);
        fillSpace(world, box, 25, 21, 5, new int[] {0, 0, 0, 0, 1, 0}, ModBlocks.radio_telex, EnumFacing.WEST);
        setBlockState(world, ModBlocks.radio_torch_sender.getStateFromMeta(0), 26, 20, 8, box); //Launchpad lever
        setRTTYFreq(world, box, 26, 20, 8, freq);
        setBlockState(world, ModBlocks.radio_torch_sender.getStateFromMeta(0), 25, 20, 7, box); //hatch lever
        setRTTYFreq(world, box, 25, 20, 7, freqHatch);

        //Machine/Small Desk Area
        setBlockState(world, ModBlocks.deco_pipe_framed_green_rusted.getStateFromMeta(pillarWE), 23, 23, 1, box);
        fillWithMetadataBlocks(world, box, 16, 23, 1, 19, 23, 1, ModBlocks.deco_pipe_framed_green_rusted, pillarWE);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 20, 21, 1, box);
        setBlockState(world, ModBlocks.capacitor_copper.getStateFromMeta(decoN), 20, 22, 1, box);
        setBlockState(world, ModBlocks.reinforced_stone_stairs.getStateFromMeta(stairS | 4), 21, 21, 1, box);
        setBlockState(world, ModBlocks.deco_crt.getStateFromMeta(getCRTMeta(2) | 4), 21, 22, 1, box);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 22, 21, 1, box);
        setBlockState(world, ModBlocks.capacitor_copper.getStateFromMeta(decoN), 22, 22, 1, box);
        fillWithBlocks(world, box, 20, 23, 1, 22, 23, 1, ModBlocks.deco_steel);
        setBlockState(world, ModBlocks.hev_battery.getStateFromMeta(0), 23, 21, 1, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST), 18, 21, 2, box);
        fillWithBlocks(world, box, 16, 21, 1, 16, 21, 3, ModBlocks.deco_steel);

        setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(decoModelE), 16, 22, 2, box);
        setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 16, 22, 3, box);
        ...
        setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 25, 20, 9, box);
        ...
        setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 24, 20, 20, box);
        ...
        //Railing and Deco
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 18, 5, 11, box);
        ...
        setBlockState(world, ModBlocks.fence_metal.getStateFromMeta(0), 20, 5, 17, box);
        ...
        setBlockState(world, Blocks.AIR.getStateFromMeta(0), 21, 5, 17, box);
        setBlockState(world, Blocks.AIR.getStateFromMeta(0), 17, 5, 11, box);
        ...
        fillSpace(world, box, 19, 1, 14, new int[] {0, 0, 1, 1, 1, 1}, ModBlocks.launch_pad_rusted, EnumFacing.SOUTH);
        for(int i = 0; i <= 2; i += 2)
            for(int k = 0; k <= 2; k += 2)
                makeExtra(world, box, ModBlocks.launch_pad_rusted, 18 + i, 1, 13 + k);
        setBlockState(world, ModBlocks.radio_torch_receiver.getStateFromMeta(3), 19, 0, 14, box);
        ...
        setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 12, 16, 14, box);
        //Walls
        //N
        ...
        setBlockState(world, ModBlocks.concrete_colored.getStateFromMeta(14), 5, 18, 8, box);
        setBlockState(world, ModBlocks.concrete_colored.getStateFromMeta(14), 8, 18, 8, box);
        ...
        //Deco
        //Living Room
        setBlockState(world, ModBlocks.reinforced_stone_stairs.getStateFromMeta(stairW | 4), 12, 17, 17, box);
        setBlockState(world, Blocks.CAULDRON.getStateFromMeta(0), 12, 17, 18, box);
        fillWithMetadataBlocks(world, box, 12, 17, 19, 12, 17, 20, ModBlocks.reinforced_stone_stairs, stairW | 4);
        setBlockState(world, ModBlocks.machine_electric_furnace_off.getStateFromMeta(decoE), 12, 17, 21, box);
        setBlockState(world, ModBlocks.deco_toaster.getStateFromMeta(getCRTMeta(3) | 4), 12, 18, 17, box);
        placeLever(world, box, 2, true, 12, 18, 18);
        setBlockState(world, ModBlocks.machine_microwave.getStateFromMeta(decoE), 12, 18, 19, box);
        setBlockState(world, ModBlocks.hev_battery.getStateFromMeta(0), 12, 18, 20, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.SOUTH), 8, 17, 17, box);
        ...
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.NORTH), 8, 17, 22, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.EAST), 10, 17, 23, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.SOUTH), 11, 17, 23, box);
        setBlockState(world, Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST), 12, 17, 23, box);
        fillWithMetadataBlocks(world, box, 10, 17, 25, 12, 17, 25, ModBlocks.reinforced_stone_stairs, stairN | 4);
        setBlockState(world, ModBlocks.deco_crt.getStateFromMeta(getCRTMeta(0)), 11, 18, 25, box);

        //Bathroom
        setBlockState(world, ModBlocks.reinforced_stone.getStateFromMeta(0), 6, 17, 17, box);
        fillWithBlocks(world, box, 6, 17, 18, 6, 17, 20, Blocks.CAULDRON);
        setBlockState(world, ModBlocks.reinforced_stone.getStateFromMeta(0), 6, 17, 21, box);
        for(int i = 0; i < 3; i++)
            placeLever(world, box, 2, true, 6, 18, 18 + i);
        setBlockState(world, Blocks.HOPPER.getStateFromMeta(decoW), 6, 17, 24, box);
        setBlockState(world, Blocks.TRAPDOOR.getStateFromMeta(decoModelW >> 2), 6, 18, 24, box);
        //Bedroom
        for(int i = 3; i <= 7; i += 2)
            setBlockState(world, ModBlocks.reinforced_stone_stairs.getStateFromMeta(stairN | 4), i, 17, 11, box);
        ...
        setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 26, 12, 14, box);
        //Walls
        //N
        ...
        //Deco
        //Room 1
        setBlockState(world, ModBlocks.crate_ammo.getStateFromMeta(0), 27, 13, 9, box);
        setBlockState(world, ModBlocks.crate_can.getStateFromMeta(0), 27, 13, 10, box);
        setBlockState(world, ModBlocks.crate_can.getStateFromMeta(0), 27, 14, 9, box);
        setBlockState(world, ModBlocks.crate_can.getStateFromMeta(0), 28, 13, 9, box);
        setBlockState(world, ModBlocks.barrel_corroded.getStateFromMeta(0), 29, 13, 9, box);
        //Room 2
        setBlockState(world, ModBlocks.crate_can.getStateFromMeta(0), 31, 13, 9, box);
        setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(decoModelE), 31, 13, 11, box);

        setBlockState(world, ModBlocks.crate_can.getStateFromMeta(0), 33, 13, 11, box);
        //Workshop
        setBlockState(world, ModBlocks.machine_transformer.getStateFromMeta(0), 33, 13, 17, box);
        fillWithRandomizedBlocks(world, box, 33, 13, 18, 33, 13, 20, rand, Supplies);

        setBlockState(world, ModBlocks.anvil_iron.getStateFromMeta(decoN), 31, 13, 21, box);
        fillWithBlocks(world, box, 28, 13, 18, 29, 13, 20, Blocks.PLANKS);
        setBlockState(world, Blocks.CRAFTING_TABLE.getDefaultState(), 29, 13, 19, box);
        setBlockState(world, ModBlocks.radiorec.getStateFromMeta(decoE), 28, 14, 19, box);
        setBlockState(world, ModBlocks.deco_toaster.getStateFromMeta(getCRTMeta(1)), 28, 13, 17, box);
        ...
        //Floor + Ceiling
        setBlockState(world, ModBlocks.concrete_smooth.getStateFromMeta(0), 12, 8, 14, box);
        ...
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 16, 11, 14, box);
        fillWithMetadataBlocks(world, box, 13, 11, 14, 15, 11, 14, ModBlocks.deco_pipe_quad_rusted, pillarWE);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 12, 11, 14, box);
        fillWithMetadataBlocks(world, box, 10, 11, 14, 11, 11, 14, ModBlocks.deco_pipe_quad_rusted, pillarWE);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 9, 11, 14, box);
        ...
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 9, 8, 23, box);
        setBlockState(world, ModBlocks.deco_pipe_quad_rusted.getStateFromMeta(pillarWE), 10, 11, 20, box);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 11, 11, 20, box);
        fillWithBlocks(world, box, 11, 9, 20, 11, 10, 20, ModBlocks.deco_pipe_framed_rusted);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 11, 8, 20, box);
        setBlockState(world, ModBlocks.deco_pipe_quad_rusted.getStateFromMeta(pillarWE), 8, 11, 20, box);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 7, 11, 20, box);
        fillWithBlocks(world, box, 7, 9, 20, 7, 10, 20, ModBlocks.deco_pipe_framed_rusted);
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 7, 8, 20, box);
        fillWithBlocks(world, box, 8, 8, 18, 10, 8, 22, ModBlocks.deco_lead);
        //Barrels in tank room
        setBlockState(world, ModBlocks.lox_barrel.getStateFromMeta(0), 7, 9, 17, box);
        setBlockState(world, ModBlocks.pink_barrel.getStateFromMeta(0), 11, 9, 19, box);
        setBlockState(world, ModBlocks.pink_barrel.getStateFromMeta(0), 11, 9, 22, box);
        fillWithBlocks(world, box, 11, 9, 23, 11, 10, 23, ModBlocks.pink_barrel);
        setBlockState(world, ModBlocks.pink_barrel.getStateFromMeta(0), 10, 9, 23, box);
        ...
        //Generator Room
        setBlockState(world, ModBlocks.barrel_corroded.getStateFromMeta(0), 1, 9, 11, box);
        ...
        setBlockState(world, ModBlocks.barrel_corroded.getStateFromMeta(0), 2, 9, 7, box);
        ...
        setBlockState(world, ModBlocks.red_cable_gauge.getStateFromMeta(decoE), 7, 10, 9, box);
        ...
        setBlockState(world, ModBlocks.deco_steel.getStateFromMeta(0), 28, 0, 11, box);
        ...
        setBlockState(world, ModBlocks.hev_battery.getStateFromMeta(0), 30, 2, 11, box);
    ...
    public static WeightedRandomChestContentFrom1710[] launchKey = new WeightedRandomChestContentFrom1710[] { new WeightedRandomChestContentFrom1710(ModItems.launch_key, 0, 1, 1, 1) };
    ...
    protected void setRTTYFreq(World world, StructureBoundingBox box, int featureX, int featureY, int featureZ, int freq) {
        ...
        TileEntityRadioTorchBase torch = (TileEntityRadioTorchBase) world.getTileEntity(pos);
    ...
    public static class ConcreteStairs extends BlockSelector {
        ...
        public void selectBlocks(Random rand, int posX, int posY, int posZ, boolean notInterior) {
            ...
            if(chance < 0.4F)
                this.blockstate = ModBlocks.brick_concrete_stairs.getStateFromMeta(meta);
            else if (chance < 0.7F)
                this.blockstate = ModBlocks.brick_concrete_mossy_stairs.getStateFromMeta(meta);
            else if (chance < 0.9F)
                this.blockstate = ModBlocks.brick_concrete_cracked_stairs.getStateFromMeta(meta);
            else
                this.blockstate = ModBlocks.brick_concrete_broken_stairs.getStateFromMeta(meta);
    ...
    public static class DestroyedBricks extends BlockSelector {
        ...
        public void selectBlocks(Random rand, int posX, int posY, int posZ, boolean notInterior) {
            ...
            if (chance < 0.3F) {
                int meta;
                float slabVariantChance = rand.nextFloat();

                if (slabVariantChance >= 0.4F && slabVariantChance < 0.7F) {
                    meta = 1;
                } else if (slabVariantChance < 0.9F) {
                    meta = 2;
                } else {
                    meta = 3;
                }
                ...
                float stairChance = rand.nextFloat();

                if (stairChance < 0.4F) {
                    this.blockstate = ModBlocks.brick_concrete_stairs.getStateFromMeta(meta);
                } else if (stairChance < 0.7F) {
                    this.blockstate = ModBlocks.brick_concrete_mossy_stairs.getStateFromMeta(meta);
                } else if (stairChance < 0.9F) {
                    this.blockstate = ModBlocks.brick_concrete_cracked_stairs.getStateFromMeta(meta);
                } else {
                    this.blockstate = ModBlocks.brick_concrete_broken_stairs.getStateFromMeta(meta);
                }
            } else if (chance < 0.9F) {
                float brickChance = rand.nextFloat();

                if (brickChance < 0.4F) {
                    this.blockstate = ModBlocks.brick_concrete.getDefaultState();
                } else if (brickChance < 0.7F) {
                    this.blockstate = ModBlocks.brick_concrete_mossy.getDefaultState();
                } else if (brickChance < 0.9F) {
    ...
    public static class SiloSupplies extends BlockSelector {
        ...
        public void selectBlocks(Random rand, int posX, int posY, int posZ, boolean notInterior) {
            ...
            if(chance < 0.2F)
                this.blockstate = ModBlocks.barrel_corroded.getDefaultState();
            else if(chance < 0.4F)
                this.blockstate = ModBlocks.crate_can.getDefaultState();
            else if(chance < 0.45F)
                this.blockstate = ModBlocks.red_barrel.getDefaultState();
            else if(chance < 0.5F)
                this.blockstate = ModBlocks.pink_barrel.getDefaultState();
            else
                this.blockstate = Blocks.AIR.getDefaultState();
        }
    }
            ...
            for(int z = minZ; z <= maxZ; z++) {
                ...
                if(posX >= box.minX && posX <= box.maxX && posZ >= box.minZ && posZ <= box.maxZ) {
                    for(int y = minY; y <= maxY; y++) {
                        ...
                        if(rand.nextInt(15) == 0 && world.getBlockState(pos) == Blocks.AIR.getDefaultState() && world.getBlockState(pos.down()) != Blocks.AIR.getDefaultState()) {
                            world.setBlockState(pos, ModBlocks.mine_ap.getDefaultState(), 2);

                            TileEntityLandmine mine = (TileEntityLandmine)world.getTileEntity(pos);
                            if(mine != null)
    ...
    protected void placeCoreLaunchpad(World world, StructureBoundingBox box, Block block, ForgeDirection dir, int x, int y, int z) {
        ...
        EnumFacing efDir = getDirection(dir.getOpposite().toEnumFacing());
        world.setBlockState(pos, block.getStateFromMeta(efDir.ordinal() + BlockDummyable.offset), 2);

        TileEntity launchpad = world.getTileEntity(pos);
    ...
    protected StructureBoundingBox getRotatedBoundingBox(int minX, int minY, int minZ, int maxX, int maxY, int maxZ) {
        ...
        if (facing == null || facing == EnumFacing.NORTH || facing == EnumFacing.SOUTH) {
