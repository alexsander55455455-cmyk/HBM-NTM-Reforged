...
//        put(TileEntityFF.class, "tileentity_forcefield");
        ...
        put(TileEntityMachineAmgen.class, "tileentity_machine_amgen");
...
//        put(TileEntityMachineDetector.class, "tileentity_he_detector");
        ...
        put(TileEntityMachineUUCreator.class, "tileentity_uu_creator");
...
//        }
    ...
    public static void putLegacy(String namespace, Class<? extends TileEntity> clazz, String... names) {
        for (String name : names) {
            map.put(namespace + ":" + name, clazz);
        }
    }
