...
public class ItemPoolsC130 {
    ...
    public static void init() {
        ...
        new ItemPool(POOL_AMMO) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.M357_SP.ordinal(), 12, 12, 10),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.M357_FMJ.ordinal(), 6, 6, 10),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.M44_SP.ordinal(), 12, 12, 5),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.M44_FMJ.ordinal(), 6, 6, 5),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.P9_SP.ordinal(), 12, 12, 10),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.P9_FMJ.ordinal(), 6, 6, 10),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.R762_SP.ordinal(), 6, 6, 5),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.G12_BP.ordinal(), 6, 6, 10),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.ROCKET_HE.ordinal(), 1, 1, 3),
            };
        }};
    }
}
