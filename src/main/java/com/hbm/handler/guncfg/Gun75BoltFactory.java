...
public class Gun75BoltFactory {
	...
	public static BulletConfiguration get75BoltConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_75bolt);
		bullet.ammoCount = 30;
	...
	public static BulletConfiguration get75BoltIncConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_75bolt_incendiary);
		bullet.ammoCount = 30;
		bullet.spread *= inaccuracy;
		bullet.dmgMin = 26;
		bullet.dmgMax = 36;
	...
	public static BulletConfiguration get75BoltHEConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_75bolt_he);
		bullet.ammoCount = 30;
		bullet.spread *= inaccuracy;
		bullet.dmgMin = 32;
		bullet.dmgMax = 48;
